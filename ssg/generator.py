    ...
    <body class="bgc">
        <header class="container">
            <article style="position: relative;">
                ...
                <a style="top:4px; right:12px;" class="gh" rel="noopener noreferrer" class="contrast" aria-label="Telegram Channel" href="https://t.me/screenshotru" target="_blank">
                ...
                <a style="top:4px; right:44px;" class="gh" rel="noopener noreferrer" class="contrast" aria-label="GitHub repository" href="https://github.com/snegovik2049/screenshot" target="_blank">
